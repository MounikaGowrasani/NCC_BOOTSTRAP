...
$sql = "SELECT regimental_number,stu_name,photo_data FROM enroll where  ncc_unit_enrolled='138-B,25(A)BN NCC,Guntur' OR ncc_unit_enrolled='25A'";
...
header('Content-Disposition: attachment; filename="student(25A).xls"');
